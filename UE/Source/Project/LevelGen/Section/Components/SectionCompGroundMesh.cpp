#include "SectionCompGroundMesh.h"
#include "Project/ProcGen/FaceMeshGeneration.h"
#include "Project/LevelGen/Section/SectionGenerator.h"

void USectionCompGroundMesh::PopulateRoom(ASectionGenerator* aGenerator, const FProcSection& aSection,const FProcRoom& aRoom)
{
